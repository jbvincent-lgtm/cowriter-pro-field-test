(function(root,factory){
  ...
  function visualReview(){
    ...
    song.plan.brainDump=`SCREENSHOT NOTEBOOK\n\nA deliberately complete song for reviewing Welcome, Library, Plan, Shape, Write, Shelf, Alternatives and Chart without preparing content first.\n\nVisual anchors: porch light in rain; red dust on the case; a motel key; handwriting in the chart margin.\n\nReview path: capture Plan, arrange the labelled fragments in Shape, open Words and Music in the Shelf, select a chorus line and open Alternatives, then finish in Chart settings.`;
    ...
    song.favourite=true;
    addVersions(song,['Review baseline','Shelf populated','Chart-ready review']);
    return song;
  }
