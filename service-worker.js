...
const CACHE=`${CACHE_PREFIX}0.6.7-r2-726f64f1d6c2`;
const ownsCache=key=>key.startsWith(CACHE_PREFIX);
const SHELL=['./','./index.html','./assets/cowriter.css?v=0.6.7-r2-726f64f1d6c2','./assets/cowriter.js?v=0.6.7-r2-726f64f1d6c2','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
