...
const CHANNEL='personal-test-next-04';
const CACHE_PREFIX=`co-writer-${CHANNEL}-${encodeURIComponent(SCOPE_PATH)}-`;
const CACHE=`${CACHE_PREFIX}0.6.7-r2-a0ce8c99fb8c`;
const ownsCache=key=>key.startsWith(CACHE_PREFIX);
const SHELL=['./','./index.html','./assets/cowriter.css?v=0.6.7-r2-a0ce8c99fb8c','./assets/cowriter.js?v=0.6.7-r2-a0ce8c99fb8c','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
