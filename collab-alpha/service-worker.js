...
const CACHE=`${CACHE_PREFIX}0.6.3-r2`;
const ownsCache=key=>key.startsWith(CACHE_PREFIX)||(CHANNEL==='stable'&&/^co-writer-\d/.test(key));
const SHELL=['./','./index.html','./assets/cowriter.css?v=0.6.3-r2','./assets/cowriter.js?v=0.6.3-r2','./manifest.webmanifest','./icon-192.png','./icon-512.png'];
