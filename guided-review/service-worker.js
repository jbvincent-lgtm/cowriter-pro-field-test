...
const CACHE=`${CACHE_PREFIX}0.6.7-r2-d89bd282d529`;
const ownsCache=key=>key.startsWith(CACHE_PREFIX);
const SHELL=['./','./index.html','./assets/cowriter.css?v=0.6.7-r2-d89bd282d529','./assets/cowriter.js?v=0.6.7-r2-d89bd282d529','./manifest.webmanifest','./icon-192.png','./icon-512.png','./THIRD-PARTY-NOTICES.txt'];
