...
G – D/F# – Em7 – Cadd9. Keep the verse conversational. Let the bridge lift somewhere brighter and make that brightness hurt.`;
  ...
  function renderMobileShape(song){
    const view=document.createElement('div');view.className='shape-mobile';const intro=document.createElement('header');intro.className='shape-mobile-intro';intro.innerHTML='<div><span>SHAPE</span><h2>Arrange the song</h2></div><p>Move loose lines into sections. Reorder them until the form feels right.</p>';view.append(intro);
